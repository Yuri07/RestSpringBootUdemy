...
//@EnableWebMvc comentado pq foi colocado anotacoes em startup.java (@EnableAutoConfiguration e @ComponentScan)
@Configuration
public class WebConfig implements WebMvcConfigurer{
	...
	public void addCorsMappings(CorsRegistry registry) {
		registry.addMapping("/**")		//disponivel para qualquer origem globalmente
